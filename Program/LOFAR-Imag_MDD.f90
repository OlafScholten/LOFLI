...
! v22.01: chi^2 fitting of antenna delays in TRI-D mode for calibration
   ...
   ! Other, RFI-Mitigat 0
      CASE("S")  ! SelectData                          RunMode=0
         ...
         Call PrintValues(Simulation, 'Simulation', 'Creating for the "Simulation" files with the antenna info and data.' ) !
