...
An additional parameter is \verb#"ImpImWeights"#,as introduced already in \secref{FiCal}.

\subsection{details}

The results for the source locations are written to \verb!Srcs26-dblxxxx.csv! or otherwise the files \verb!Srcs26-oddxxxx.csv! and \verb!Srcs26-evenxxxx.csv! in the \verb#"! files"# sub-folder of the FlashFolder working directory.
...
\\col6: $\chi^2$, if this had units, they would be [ns$^2$] and is basically a mean-square deviation. When \verb#"ImpImWeights=.true."# this is no longer the case.
