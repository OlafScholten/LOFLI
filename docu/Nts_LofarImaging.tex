...
\centerline{\Large  Guide to the LOFLI 2.0 program suite, V26}


\newpage

\vspace{2ex}
This guide is structured chronologically to detail the main steps in converting LOFAR TBB data into an image of a lightning flash. Each chapter focuses on a specific part of the process. For an overview of the fundamental imaging methodology, refer to \cite{Scholten:2021-init}. Editions beyond version 21 also feature routines for Beamforming and Polarimetry (TRI-D\cite{Scholten:2021-INL,Scholten:2022} \& ATRI-D~\cite{Scholten:2025} imagers).
