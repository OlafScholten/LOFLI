...
! copied from C:\Users\Olaf Scholten\Documents\AstroPhys\Lightning\Imaging\LOFAR-MAP
   ...
   Use DS_Select, only : RA, maxd, SourcTotNr, Label, QualIndic, t_offset, tCutl, tCutu, xyztBB
   Use DS_Select, only : SrcWidth, Iperm, SrcChi2, SrcI20, SrcI3, SrcUn, SrcLin, SrcCirc, SrcPZen, SrcPAzi
...
998   write(2,*) '======================================='
      ...
      ElseIf(DS_Mode .eq. 3) Then ! ATRID
         DeAllocate( SrcWidth, SrcChi2, SrcI3, SrcUn, SrcLin, SrcCirc, SrcPZen, SrcPAzi, Stk_NEh )
      EndIf
