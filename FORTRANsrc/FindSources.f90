...
!
!     Safety is used in SearchWin to adjust the window where pulses are being looked for.
!     Safety is also used in "GetCorrSingAnt" to set the range over which the correlations are calculated.
